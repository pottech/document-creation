		...
		<dl class="info-list">
			<div class="info-item">
				...
				<dd>
					...
					<button type="button" class="copy-btn" onclick={() => copyToClipboard(data.client.keycloakClientId)}>
						コピー
					</button>
				</dd>
			</div>
			...
			<div class="info-item">
				<dt>スコープ</dt>
				<dd>
					{#if data.client.hospital}
						<span class="scope-badge hospital">{data.client.hospital.name}</span>
					{:else}
						<span class="scope-badge system">システム全体</span>
					{/if}
				</dd>
			</div>
