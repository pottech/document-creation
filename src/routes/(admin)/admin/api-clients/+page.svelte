...
<div class="page">
	<div class="page-header">
		<h1>APIクライアント管理</h1>
		<a href="/admin/api-clients/new" class="btn-primary">新規作成</a>
	</div>
				...
				<tbody>
					{#each data.clients as client}
						<tr>
							...
							<td>
								{#if client.hospital}
									<span class="scope-badge hospital">{client.hospital.name}</span>
								{:else}
							...
							<td>
								<a href="/admin/api-clients/{client.id}" class="link">詳細</a>
							</td>
						</tr>
					{/each}
				</tbody>
